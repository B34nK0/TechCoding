...
function(build_file_tree)
	FILE(GLOB_RECURSE ALL_SOURCE_LIST . "*.h" "*.hpp" "*.cpp" "*.c")
...
function(FilterFile)
    get_property(tmp GLOBAL PROPERTY filterFiles)
    foreach(file IN ITEMS ${ARGN})
        if(${file} MATCHES  "./linux/")
            if(CMAKE_SYSTEM_NAME MATCHES "Linux")
                list(APPEND tmp ${file})
            endif()
        elseif(${file} MATCHES  "./windows/")
    ...
    endforeach()
    set_property(GLOBAL PROPERTY filterFiles "${tmp}")
endfunction()
